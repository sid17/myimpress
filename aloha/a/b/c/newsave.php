...
*/
 ...
 <body style="background-color:#91CCFF;">
 <div id="impress">
 <?php
...
{
("<?php echo $_GET['bcolor']?>and<?php echo($_GET['scolor'])?>");
document.body.style.backgroundColor="<?php echo $_GET['bcolor']?>";
document.body.style.backgroundImage="<?php echo $_GET['bimage']?>";
var x=document.getElementsByClassName('step');
var i;
for (i=0;i<x.length;i++)
{
 x[i].style.backgroundColor="<?php echo $_GET['scolor']?>";
}
