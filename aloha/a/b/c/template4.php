...
$conresult=mysql_query("SELECT * FROM siddhant",$connection);
...
<form id="pageform" method="POST" action="addpage.php">
 ...
 function deletepage()
 {
  ...
  Aloha.ready(function( ) {
           ...
           q="s"+(j);
            ...
            $('#delid').html(q);
            $.post("deletepage.php", $("#delform").serialize(),
                   function(data) {
			       if (data)
                               {
